...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0004_auto_20150702_0045'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='first_name',
            field=models.CharField(default='  ', max_length=255, verbose_name='\u0418\u043c\u044f', blank=True),
        ...
        migrations.AddField(
            model_name='user',
            name='last_name',
            field=models.CharField(default=' ', max_length=255, verbose_name='\u0424\u0430\u043c\u0438\u043b\u0438\u044f', blank=True),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='user',
            name='bike',
            field=models.CharField(max_length=255, null=True, verbose_name='\u0411\u0430\u0439\u043a', blank=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='user',
