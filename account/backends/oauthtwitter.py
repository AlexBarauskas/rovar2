...
class OAuthApi(Api):
    ...
    def getAccessToken(self, url=ACCESS_TOKEN_URL,
                       verifier=None):
        ''' If ``callback'' parameter has been specified for getRequestToken
            call then verifier must be specified.
        '''
    ...
    def getRequestToken(self, url=REQUEST_TOKEN_URL,
        ...
        If ``callback'' is provided
           then it will be used as 'oauth_callback' parameter for url.
        ...
        if callback is not None:
            parameters['x_auth_access_type'] = access
    ...
    def GetUserInfo(self, url='https://twitter.com/account/verify_credentials.json'):
        ...
        '''
        url = 'https://api.twitter.com/1.1/account/verify_credentials.json' #account/settings.json'
