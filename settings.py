...
DATABASES = {
    'default': {
        ...
        'NAME': 'rovar.db',                      # Or path to database file if using sqlite3.
...
SECURITY_MEDIA_ROOT = os.path.join(PROJECT_ROOT, 'security-media')
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'account/static'),
...
SECRET_KEY = '%uux_gw*$7^!f=q$)1zfjjzz2y5tve+1*qe+pf%m&u7fwo%gb_'
